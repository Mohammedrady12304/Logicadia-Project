        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NarrativeText = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderIndex = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stories_Levels_LevelId",
                        column: x => x.LevelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    XpValue = table.Column<int>(type: "int", nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ScenarioId = table.Column<int>(type: "int", nullable: false),
                    ChosenChoiceId = table.Column<int>(type: "int", nullable: false),
                    IsCorrect = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProgress_Choices_ChosenChoiceId",
                        column: x => x.ChosenChoiceId,
                        principalTable: "Choices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserProgress_Scenarios_ScenarioId",
                        column: x => x.ScenarioId,
                        principalTable: "Scenarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderTxId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Achievements_TriggerType",
                table: "Achievements",
                column: "TriggerType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Choices_ScenarioId_IsCorrect",
                table: "Choices",
                columns: new[] { "ScenarioId", "IsCorrect" });

            migrationBuilder.CreateIndex(
                name: "IX_Levels_OrderIndex",
                table: "Levels",
                column: "OrderIndex",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scenarios_StoryId_OrderIndex",
                table: "Scenarios",
                columns: new[] { "StoryId", "OrderIndex" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Stories_LevelId",
                table: "Stories",
                column: "LevelId");

            migrationBuilder.CreateIndex(
                name: "IX_Stories_LevelId_OrderIndex",
                table: "Stories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProgress_ChosenChoiceId",
                table: "UserProgress",
                column: "ChosenChoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProgress_CompletedAt",
                table: "UserProgress",
                column: "CompletedAt");

            migrationBuilder.CreateIndex(
                name: "IX_UserProgress_ScenarioId",
                table: "UserProgress",
                column: "ScenarioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProgress_UserId_ScenarioId",
                table: "UserProgress",
